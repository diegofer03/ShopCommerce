...
const Home = () => {
  ...
  return (
    <>
      ...
      <input type="text" className='rounded-lg border border-black w-80 p-3 mb-4 focus:outline-none' placeholder='Search product' onChange={(e) => setSeacth(e.target.value)}/>
