...
const Home = () => {
  ...
  return (
    <>
      ...
      <input type="text" className='rounded-lg border border-black sm:w-80 w-7/12 p-3 mb-4 focus:outline-none
       dark:bg-black dark:border-white' placeholder='Search product' onChange={(e) => setSeacth(e.target.value)}/>
      <div className='h-[85%] overflow-x-auto max-w-screen-lg ' ref={listInnerRef} onScroll={onScroll}>
